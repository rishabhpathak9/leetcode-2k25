 ...
 * The score of a triangulation is the sum of the products of the lengths of each triangle's edges.
 * Two triangulations of a polygon have the same set of edges except the diagonals.
